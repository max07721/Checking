...
const routes = [
	...
	// 学生签到路由
	{
		path: '/student_check_in/table',
		name: 'student_check_in_table',
		component: () => import('../views/student_check_in/table.vue'),
		meta: {
			index: 0,
			title: '学生签到列表'
		}
	...
	{
		path: '/student_check_in/view',
		name: 'student_check_in_view',
		component: () => import('../views/student_check_in/view.vue'),
		meta: {
			index: 0,
			title: '学生签到详情'
		}
